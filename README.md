...
|---------|-------------|------|-------|
| [**Lite-PHP**](https://github.com/ArefShojaei/Lite-PHP) | Micro PHP Framework with modular structure, hooks & CLI | PHP | ![Stars](https://img.shields.io/github/stars/ArefShojaei/Lite-PHP?style=social) |
| [**Delta**](https://github.com/ArefShojaei/Delta) | Powerful PHP Framework for clean REST APIs | PHP | ![Stars](https://img.shields.io/github/stars/ArefShojaei/Delta?style=social) |
